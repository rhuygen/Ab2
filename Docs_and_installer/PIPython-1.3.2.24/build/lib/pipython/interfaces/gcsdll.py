...
UNIXDLL = {
    'E7XX_GCS_DLL': 'libpi_e7xx_gcs.so',
    'PI_HydraPollux_GCS2_DLL': 'libpi_hydrapollux.so',
    'PI_GCS2_DLL': 'libpi_pi_gcs2.so',
}
...
def get_dll_name(devname):
    ...
    if not devname:
        ...
        if devname.upper() not in ('C-663.11', 'C-863.11', 'C-663.10', 'C-863.10'):
