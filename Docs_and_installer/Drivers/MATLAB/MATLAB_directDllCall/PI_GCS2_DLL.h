...
BOOL PI_FUNC_DECL PI_TRI(int ID, const int* piTriggerChannelIds, const BOOL* pbTriggerChannelEnabel, int iArraySize);
BOOL PI_FUNC_DECL PI_qTRI(int ID, const int* piTriggerChannelIds, BOOL* pbTriggerChannelEnabel, int iArraySize);
BOOL PI_FUNC_DECL PI_CTI(int ID, const int* piTriggeIdsArray, const int* piTriggerParameterArray, const char* szValueArray, int iArraySize);
BOOL PI_FUNC_DECL PI_qCTI(int ID, const int* piTriggerIdsArray, const int* piTriggerParameterArray, char* szValueArray, int iArraySize, int maxBufLen);
