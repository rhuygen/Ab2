...
class GCSCommands(object):
    ...
    def floatformat(self):
        ...
        if 'floatformat' not in self.__settings:
            self.__settings['floatformat'] = '.8f'
    ...
    def FDR(self, routinename, scanaxis, scanrange, stepaxis, steprange, threshold=None, aligninputchannel=None,
            frequency=None, velocity=None, scanmiddlepos=None, stepmiddlepos=None, targettype=None, centroidmodel=None,
            mininput=None, maxinput=None, stopoption=None):
        ...
        @param centroidmodel : Data set will be post calculated, so that the theoretical maximum refers to a given
        ...
        debug('GCSCommands.FDR(routinename=%r, scanaxis=%r, scanrange=%r, stepaxis=%r, steprange=%r, threshold=%r, '
              ...
              'targettype=%r, centroidmodel=%r, mininput=%r, maxinput=%r, stopoption=%r)',
              routinename, scanaxis, scanrange, stepaxis, steprange, threshold, aligninputchannel, frequency, velocity,
              scanmiddlepos, stepmiddlepos, targettype, centroidmodel, mininput, maxinput, stopoption)
        ...
        cmdstr += '' if centroidmodel is None else ' %s' % self.__getcmdstr('CM', centroidmodel)
    ...
    def qFRR(self, name=None, resultid=None):
        ...
        @param name : Name of fast alignment process as string.
        @param resultid : Identifier of the desired result as integer, see controller manual.
    ...
    def HLT(self, axes=None):
        ...
        Error code 10 is set. HLT() does not stop macros.
        @param axes : String convertible or list of them or None.
        """
    ...
    def WTR(self, wavegens, tablerates, interpol):
        ...
        @param tablerates : Duration of a wave table point as integer convertible or list of them.
    ...
    def OAC(self, channels, values=None):
        """Set open-loop acceleration of the PiezoWalk 'channels'.
        ...
        @param values : Float or list of floats or None.
        """
        debug('GCSCommands.OAC(channels=%r, values=%r)', channels, values)
        channels, values = getitemsvaluestuple(channels, values)
        cmdstr = self.__getcmdstr('OAC', channels, values)
        self.__msgs.send(cmdstr)
    ...
    def WOS(self, channels, values=None):
        """Set offsets to the output of wave generator 'channels'.
        ...
        @param values : Float or list of floats or None.
        """
        debug('GCSCommands.WOS(channels=%r, values=%r)', channels, values)
        channels, values = getitemsvaluestuple(channels, values)
        cmdstr = self.__getcmdstr('WOS', channels, values)
        self.__msgs.send(cmdstr)
    ...
    def WAV_LIN(self, table, firstpoint, numpoints, append, speedupdown, amplitude, offset, seglength):
        ...
        @param firstpoint : Index of the starting point in the segment as integer, starts with 0.
    ...
    def qHIS(self):
        ...
        @return : Answer as string with trailing linefeed.
        """
        debug('GCSCommands.qHIS()')
        answer = self.__msgs.read('HIS?')
        debug('GCSCommands.qHIS = %r', answer)
        return answer
    ...
    def qSWT(self, axis, index):
        ...
        """
        debug('GCSCommands.qSWT(axis=%r, index=%r)', axis, index)
        checksize((1, 1), axis, index)
        cmdstr = self.__getcmdstr('SWT?', axis, index)
        answer = self.__msgs.read(cmdstr)
        value = float(answer.strip())
    ...
    def qDRL(self, channels=None):
        ...
        @return : Ordered dictionary of {channel: value}, values are int.
        """
        debug('GCSCommands.qDRL(channels=%r)', channels)
        cmdstr = self.__getcmdstr('DRL?', channels)
        answer = self.__msgs.read(cmdstr)
        answerdict = getdict_oneitem(answer, channels, valueconv=(int,), itemconv=int)
    ...
    def qWAV(self, tables=None, params=None):
        ...
        answer = self.__msgs.read(cmdstr)
        answerdict = getdict_twoitems(answer, tables, params, itemconv=[int, int],
                                      valueconv=(float,))
    ...
    def qKLT(self, csstart='', csend=''):
        ...
        @return : String with answer, lines are separated by linefeed characters.
        """
        debug('GCSCommands.qKLS(csstart=%r, csend=%r)', csstart, csend)
        if csend:
    ...
    def SPA(self, items, params=None, values=None):
        ...
        @param items : Axes/channels/systems as string convertible or list of them.
        ...
        dictionary. True/False is not allowed, use 1/0 instead.
        """
    ...
    def SEP(self, password, items, params=None, values=None):
        ...
        @param password : String convertible, usually "100".
        @param items : Axes/channels/systems as string convertible or list of them.
        @param params : Parameter ID as integer convertible or list of them.
        @param values : Parameter value to set as string convertible or list of them or None if 'items' is a
        dictionary. True/False is not allowed, use 1/0 instead.
        """
    ...
    def qSPA(self, items=None, params=None):
        ...
        @param items: Items or list of items or None.
        @param params : Integer convertible or list of them or None.
